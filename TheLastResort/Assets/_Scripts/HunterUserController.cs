...
{
	[RequireComponent(typeof (FirstPersonHunter))]
	public class HunterUserController : MonoBehaviour
	{
		private FirstPersonHunter m_Character; // A reference to the ThirdPersonCharacter on the object
